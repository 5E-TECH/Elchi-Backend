...
export class MigrateOperatorRoleToRegistrator1713208000000
  implements MigrationInterface
{
  name = 'MigrateOperatorRoleToRegistrator1713208000000';
          ...
          IF role_enum IS NOT NULL THEN
            IF NOT EXISTS (
              ...
              WHERE e.enumtypid = role_enum
                AND e.enumlabel = 'registrator'
            ) THEN
              EXECUTE format('ALTER TYPE %s ADD VALUE %L', role_enum, 'registrator');
            END IF;

            UPDATE identity_schema.admins
            SET role = 'registrator'
